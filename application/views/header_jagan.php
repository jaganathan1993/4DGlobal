...
<div class="sidenav">
  ...
  <ul class="menu">
      ...
      <li><a class="<?php  if($actlinks == "Separation") echo "active";?>" href="<?php echo base_url();?>Separation"><i class="fa fa-user-times  fa-lg" aria-hidden="true"></i> Employee Separation
      &nbsp; <span class="badge badge-danger permission_badge_count">0</span>
      </a></li>
